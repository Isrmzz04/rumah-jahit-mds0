<div class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
    <div class="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
        <h2
            ...
            Tentang Rumah Jahit MDS
        </h2>
        <p class="text-base text-gray-700 md:text-lg text-center">
            Kami berkomitmen untuk memberikan pelayanan berkualitas terbaik kepada pelanggan kami. Setiap produk jahitan
            kami ditangani dengan teliti dan cermat.
        </p>
    </div>
