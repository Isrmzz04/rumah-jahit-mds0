    ...
    <div class="max-w-xl sm:mx-auto lg:max-w-2xl">
        <div class="flex flex-col mb-16 sm:text-center">
            ...
            <div class="max-w-xl md:mx-auto sm:text-center lg:max-w-2xl">
                <h2
                    class="text-center max-w-lg mb-6 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl md:mx-auto">
                    <span class="relative inline-block">
                        <svg viewBox="0 0 52 24" fill="currentColor"
                            class="absolute top-0 left-0 z-0 hidden w-32 -mt-8 -ml-20 text-blue-gray-100 lg:w-32 lg:-ml-28 lg:-mt-10 sm:block">
                            <defs>
                                <pattern id="ec5d8ef5-b853-4714-b94f-df28ec98eeb7" x="0" y="0" width=".135"
                                    height=".30">
                ...
                <p class="text-base text-gray-700 md:text-lg">Pertanyaan yang seringkali diajukan oleh pengguna tentang
                    suatu topik atau layanan, beserta jawaban singkat yang memberikan informasi atau
                    solusi terhadap pertanyaan-pertanyaan.</p>
            </div>
        </div>
